...
public class ContextCatalogId {
  /**
   * Gets or Sets _atId
   */
  public enum AtIdEnum {
    CATALOGID("ews:catalogId");
  ...
  public ContextCatalogId _atId(AtIdEnum _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContextCatalogId contextCatalogId = (ContextCatalogId) o;
    return Objects.equals(this._atId, contextCatalogId._atId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextCatalogId {\n");
