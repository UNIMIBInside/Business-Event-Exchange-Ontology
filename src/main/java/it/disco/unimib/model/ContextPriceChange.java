...
public class ContextPriceChange {
	/**
	 * Gets or Sets _atId
	 */
	public enum AtIdEnum {
		PRICECHANGE("ews:priceChange");
	...
	public ContextPriceChange _atId(AtIdEnum _atId) {
		this._atId = _atId;
		return this;
	}
	...
	public ContextPriceChange _atType(AtTypeEnum _atType) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ContextPriceChange contextPriceChange = (ContextPriceChange) o;
		return Objects.equals(this._atId, contextPriceChange._atId)
				&& Objects.equals(this._atType, contextPriceChange._atType);
	}
	...
	public String toString() {
		...
		sb.append("class ContextPriceChange {\n");
